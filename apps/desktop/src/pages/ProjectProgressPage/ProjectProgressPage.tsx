...
export function ProjectProgressPage() {
  ...
  const counts = progress?.counts ?? { total: 0, done: 0, ready: 0, inProgress: 0, review: 0, blocked: 0, backlog: 0 };
